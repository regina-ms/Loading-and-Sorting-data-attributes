...
;// CONCATENATED MODULE: ./src/js/classTable.js
...
`;
    ...
    for (const item of data) {
      const render = mustache_mustache.render(template, {
        id: item.id,
        title: item.title,
        year: item.year,
    ...
    this.element.querySelector("tbody").insertAdjacentHTML("beforeend", innerHtml);
  }
  sortData(sortingBy) {
...
const table = new Table(document.getElementById("table"), data_namespaceObject);
table.renderHeader();
table.setData();
table.sorting();
